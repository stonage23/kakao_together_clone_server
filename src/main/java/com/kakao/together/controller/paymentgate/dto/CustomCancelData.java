...
public class CustomCancelData {
    ...
    public CustomCancelData(String uid, boolean imp_uid_or_not) {
        if (imp_uid_or_not) {
            this.imp_uid = uid;
        } else {
    ...
    public CustomCancelData(String uid, boolean imp_uid_or_not, BigDecimal amount) {
