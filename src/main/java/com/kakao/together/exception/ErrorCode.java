...
public enum ErrorCode {
    ...
    INTERNAL_SERVER_ERROR("서버 내부 문제로 요청을 처리할 수 없습니다. 잠시후 다시 시도해주세요.", "INTERNAL_SERVER_ERROR", HttpStatus.INTERNAL_SERVER_ERROR),
     ...
     * [format] 적절하지 않은 OOO: {}
      */
    INVALID_ARGUMENT("적절하지 않은 파라미터입니다.", "INVALID_ARGUMENT", HttpStatus.BAD_REQUEST),
    ...
    CONFLICT_EXCEPTION("적절하지 않은 상태 혹은 상태충돌", "CONFLICT_EXCEPTION", HttpStatus.CONFLICT),

    // 유저
    UNAUTHORIZED_EXCEPTION("로그인이 필요합니다", "UNAUTHORIZED_EXCEPTION", HttpStatus.UNAUTHORIZED),
    ...
    NOT_MATCH_PASSWORD("틀린 비밀번호입니다.", "NOT_MATCH_PASSWORD", HttpStatus.UNAUTHORIZED),
    ...
    EXPIRED_TOKEN("만료된 토큰입니다. 재로그인해주세요.", "EXPIRED_TOKEN", HttpStatus.UNAUTHORIZED),
