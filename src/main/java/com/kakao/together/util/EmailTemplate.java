...
import com.kakao.together.api.email.CreateCodeUtil;
...
public class EmailTemplate {
    ...
    public static class SignUpVerification {

        private static final String basicUrl = "kakao-together/sign-up-verification";
        private static final String CODE = CreateCodeUtil.createCode();
        ...
        public static String getTemplate() {
            ...
            template.append("<div style='margin:20px;'>")
                    ...
                    .append("<a href='" + basicUrl + "?code = " + CODE + "'>" + "클릭하여 계정을 활성화해주세요" + "</a>")
                    .append("</div>")
            ;
